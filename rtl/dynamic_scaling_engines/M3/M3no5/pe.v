...
wire Data_W_Buf_NonZero = (Data_W_Buf[`MAN-1:0] != `MAN'd0);

wire Do_Compute = Valid_P_In & Data_W_Buf_NonZero & (Data_I_In[`MAN-1:0] != 0);
reg Do_Compute_1;
...
wire signed [`BIT_DATA*2-1:0] Gated_Multiplied = {(`BIT_DATA*2){Do_Compute_1}} & Psum_Multiplied;
