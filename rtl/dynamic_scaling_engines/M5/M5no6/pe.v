...
wire Do_Compute = Valid_P_In & (~WeightZeroFlag_Buf) & (Data_I_In[`MAN-1:0] != `MAN'd0);
reg Do_Compute_1;
...
wire signed [2*`BIT_DATA-1:0] Gated_Multiplied = {(`BIT_DATA*2){Do_Compute_1}} & Psum_Multiplied;
