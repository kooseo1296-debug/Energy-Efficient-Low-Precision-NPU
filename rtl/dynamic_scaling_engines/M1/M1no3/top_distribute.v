...
// --- Wire Declarations Sorted by Number -------------------
    ...
    //8
    wire [(`BIT_DATA_C*`PE_ROW)-1:0] InputLoader_to_SysArr;
    ...
    wire [`PE_COL-1:0] WeightZeroFlag;
...
generate for (i=0;i<`PE_COL;i=i+1) begin: Loop_W
    ...
    ZeroDetect WeightZeroDetect (
        .Input(douta_WeightSRAM[i*`BIT_DATA_C+:`MAN]),
        .ZeroFlag(WeightZeroFlag[i])
        );
end
endgenerate
